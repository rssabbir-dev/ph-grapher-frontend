			...
			<div className='px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8'>
				...
				<div className='mt-12 border-t border-gray-800 pt-12'>
					...
					<p className='mt-8 text-xs text-gray-500'>
						...
						Possimus mollitia quia quod repellendus. Porro harum,
						odio dolore perspiciatis praesentium provident esse
						consequatur quibusdam aperiam, cupiditate omnis modi in
						quasi? In, maxime odio vel repellat sed earum? Debitis
						quaerat facilis animi. Odio natus nostrum laboriosam
