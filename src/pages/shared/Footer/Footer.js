...
import footerImg from '../../../assets/images/studio.jpg';
			...
			<div className='px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8'>
				<div className='grid grid-cols-1 gap-8 sm:grid-cols-2'>
					<div>
						...
						<div className='mt-16 flex gap-3'>
							...
							<a
								className='rounded-full border border-white/25 p-2 hover:opacity-75'
								href='https://www.instagram.com/sabbir.hossain.rahat/'
								target='_blank'
								rel='noreferrer'
							>
					...
					<div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
						<div>
							<p className='font-medium'>Some Link</p>

							<nav
								aria-label='Footer Nav'
								className='mt-4 flex flex-col space-y-2 text-sm text-gray-300'
							>
								<Link className='hover:opacity-75' to='/account'>
									{' '}
									Account{' '}
								</Link>
								<Link
				...
				<div className='mt-12 border-t border-gray-800 pt-12'>
					...
					<p className='mt-8 text-xs text-gray-500'>
						Ph_Grapher is a photographer services portfolio website,
						user can book schedule the photographer on give review
						on photographer services
					</p>
				</div>
			</div>
		</footer>
