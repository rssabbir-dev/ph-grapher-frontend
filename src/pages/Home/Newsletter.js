		...
		<section class='bg-gray-50'>
			<div class='p-8 md:p-12 lg:px-16 lg:py-24'>
				...
				<div class='mx-auto mt-8 max-w-xl'>
					<form onSubmit={handleSubscribe} class='sm:flex sm:gap-4'>
						<div class='sm:flex-1'>
						...
						<button class='group mt-4 flex w-full items-center justify-center rounded-md px-5 py-3  focus:outline-none sm:mt-0 sm:w-auto btn btn-primary'>
